...
public:// Operationen auf dem Graphen
    ...
    void insertVertex(int n, TV m); // fgt neuen Knoten n mit Markierung m ein
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::firstVertex() {
    for (int i = 0; i < maxNodes; i++)
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::nextVertex(int n) { // nächster Knoten nach n (-1 wenn n der letzte ist)
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::firstArc(int v) {
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::nextArc(int v, int n) {
    if (vertices[v].living == true)
        for (int i = n + 1; i < maxNodes; i++)
            if (isArc(v, i))
                return i;
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::deleteVertex(int n) {
    if (n >= 0 && n < maxNodes) {
...
template <class TV, int maxNodes>
TV Graph<TV, maxNodes>::getVertexValue(int n) {
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getOrd(int n) {
    if (n >= 0 && n < maxNodes && vertices[n].living) {
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getPredecessor(int n) {
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setOrd(int n, int o) {
    if (n >= 0 && n < maxNodes && vertices[n].living) {
        vertices[n].ord = o;
    }
}
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setVertexValue(int n, TV m) {
    if (n >= 0 && n < maxNodes && vertices[n].living) {
        vertices[n].value = m;
    }
}
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getMaxNodes() {
    return maxNodes;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getColor(int n) {
    return vertices[n].color;
}

template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setColor(int n, color_node color) {
    if (n >= 0 && n < maxNodes && vertices[n].living)
        vertices[n].color = color;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getStart(int n) {
    return vertices[n].start;
}

template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setStart(int n, int time) {
    if (n >= 0 && n < maxNodes && vertices[n].living)
        vertices[n].start = time;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getEnd(int n) {
    return vertices[n].end;
}

template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setEnd(int n, int time) {
    if (n >= 0 && n < maxNodes && vertices[n].living)
        vertices[n].end = time;
}

template <class TV, int maxNodes>
bool Graph<TV, maxNodes>::isVisited(int n) {
    if (n >= 0 && n < maxNodes && vertices[n].living) {
        return vertices[n].color;
    }
    return false;
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::insertArc(int v, int w, double weight) {
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::insertArc(int v, int w) {
    insertArc(v, w, 0);
}

template <class TV, int maxNodes>
void Graph<TV, maxNodes>::deleteArc(int v, int w) {
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::setArcWeight(int v, int w, double weight) {
    arcs[v][w] = weight;
}

template <class TV, int maxNodes>
bool Graph<TV, maxNodes>::isArc(int v, int w) {
...
template <class TV, int maxNodes>
double Graph<TV, maxNodes>::getArc(int v, int w) {
    if (isArc(v, w))
        return arcs[v][w];
    return noArc;
}
...
template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getNumArcs() {
    return numArcs;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getNumVertices() {
    return numVertices;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getIndegree(int n) {
    return vertices[n].indegree;
}

template <class TV, int maxNodes>
int Graph<TV, maxNodes>::getOutdegree(int n) {
    return vertices[n].outdegree;
}

template <class TV, int maxNodes>
void Graph<TV, maxNodes>::printVertices() {
    cout << "Knoten:" << endl;
    for (int i = 0; i < maxNodes; i++) {
        printVertex(i);
    }
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::printVertex(int n) {
    string color;
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::printAdjMatrix() {
...
template <class TV, int maxNodes>
void Graph<TV, maxNodes>::deleteGraph() {
    for (int i = 0; i < maxNodes; i++)
        deleteVertex(i);
    for (int i = 0; i < maxNodes; i++)
        for (int j = 0; j < maxNodes; j++)
